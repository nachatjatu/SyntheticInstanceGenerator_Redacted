...
def main():
    ...
    for n_ints in N_INTS:
        instance_id = f'{n_id}_{n_ints}'

        msg = f" Experiment {n_id}: n_ints = {n_ints}, instance_seed = {n_id} "
    ...
    # save results
    results_path = Path(f"results/scale_n_ints/{n_id}.json")
